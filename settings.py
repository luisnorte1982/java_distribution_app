...
BC_COMPANY_ENCODED = quote(BC_COMPANY, safe="")
BC_COMPANY_BE_ENCODED = quote(BC_COMPANY_BE, safe="")
...
ENDPOINTS = {
    "value_entries_lu": f"{BC_BASE_URL}/Company('{COMPANIES['JAVA LU']}')/ValueEntries?$filter=Posting_Date ge 2026-01-01",
    "value_entries_be": f"{BC_BASE_URL}/Company('{COMPANIES['JAVA BE']}')/ValueEntries?$filter=Posting_Date ge 2026-01-01",
