...
ENDPOINTS = {
    #"value_entries_lu": f"{BC_BASE_URL}/Company('{COMPANIES['JAVA LU']}')/ValueEntriesP5802?$top=5",
    #"value_entries_be": f"{BC_BASE_URL}/Company('{COMPANIES['JAVA BE']}')/ValueEntriesP5802?$top=5",
