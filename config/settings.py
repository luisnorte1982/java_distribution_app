...
BC_COMPANY_BE = _get_secret("BC_COMPANY_BE", "JAVA BE")
...
# ── Debug Mode ────
DEBUG_MODE = _get_secret("DEBUG_MODE", "").lower() in ("true", "1", "yes")
...
ENDPOINTS = {
    "value_entries_lu": f"{BC_BASE_URL}/Company('{COMPANIES['JAVA LU']}')/ValueEntriesP5802?$filter=Posting_Date ge 2025-01-01",
    "value_entries_be": f"{BC_BASE_URL}/Company('{COMPANIES['JAVA BE']}')/ValueEntriesP5802?$filter=Posting_Date ge 2025-01-01",
